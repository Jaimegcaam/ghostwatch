    ...
    <div className="space-y-4">
      ...
      {groups.map((group) => {
        ...
        return (
          ...
          >
            <div
              className="flex w-full items-center gap-3 px-5 py-3.5 text-left transition-colors hover:bg-gw-surface-hover"
            >
              <button
                type="button"
              ...
              >
                ...
                <span className="flex-1 text-sm font-semibold text-gw-fg">
                  {group.label}
                </span>
                <span className="text-xs text-gw-fg-muted">
                    ...
                    >
                      {userCanEdit && (
                        <div
                          ...
                          className="flex cursor-grab items-center px-2 text-gw-fg-subtle transition-colors hover:text-gw-fg-muted active:cursor-grabbing"
                        >
                      ...
                      <Link
                        ...
                        draggable={false}
                        className="block flex-1 px-5 py-4 transition-colors hover:bg-gw-surface-hover"
                        onClick={(e) => {
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-2.5">
                              <span className="truncate text-sm font-semibold text-gw-fg group-hover:text-indigo-600">
                                {check.name}
                              </span>
